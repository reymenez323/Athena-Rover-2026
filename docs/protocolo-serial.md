...
| Saber cuándo cerrar la pinza sobre la bandera | **ToF delantero (VL53L1X)** | `TLM_TOF` → medición física real, más confiable de cerca que estimar por tamaño en la imagen (solo cuando está centrada, ver `decision._aproximar_bandera`; si no, manda la cámara) |
