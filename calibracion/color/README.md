...
pesa más que con los sensores IR (ver `../calibracion/reflectancia/README.md`): la
...
Igual que con `../calibracion/reflectancia/`: esto caracteriza el sensor, no genera el
...
`calibracion/reflectancia/detector-negro-gris/`: probar combinaciones contra los CSV
...
`calibracion/reflectancia/detector-negro-gris/` (probar combinaciones contra los datos
