...
class Detection:
    ...
    # Fracción del frame (0.0-1.0) que ocupa la caja -- area / (ancho*alto).
    # A diferencia de distance_mm, no depende de ninguna calibración de
    # cámara (GeometryConfig.focal_px): es la que usa
    # decision._aproximar_bandera para decidir cuándo cerrar la pinza, ya
    # que no hay ToF que mida la distancia real. Ver el docstring de
    # ``ControlConfig.area_agarre_fraccion`` en config.py.
    area_fraccion: float | None = None
