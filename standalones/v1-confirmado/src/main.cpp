...
//
//  VARIANTE v1-confirmado: la primera versión confirmada funcionando en
//  banco de principio a fin (asegura la llave, avanza, se detiene al ver
//  la zona amarilla, retrocede y la deposita). Ante un borde negro,
//  retrocede al instante mientras siga detectándolo -- evasión reactiva
//  simple, sin maniobra de giro. Ver standalones/v2-merodeo/ para la
//  variante que en vez de eso retrocede+gira 180°+sigue merodeando.
