...
class GeometryConfig:
    ...
    ESP32, que mide de verdad en vez de estimar por tamaño aparente -- pero
    solo cuando la bandera está centrada (ver
    ``decision._aproximar_bandera``); fuera de eso, y siempre para el
    seguimiento/centrado, la única fuente es esta. O sea: que ``focal_px``
    esté sin calibrar degrada el control, no lo rompe.
